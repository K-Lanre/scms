...
const LoanApplication = () => {
  ...
  const loanTerm = watch("loanTerm") || 0;
  ...
  // Note: For better UX, we could use useEffect on watched values, but the provided snippet used onChange.
  // I will use an effect or just call it on the button as in the original snippet, or add it to onChange of inputs.
  // The original snippet used onChange={calculateLoan} on inputs. I will duplicate that.
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="50000"
                    onKeyUp={calculateLoan} // Use onKeyUp/Change to trigger
                    onChange={(e) => {
                      register("loanAmount").onChange(e); // Ensure react-hook-form still gets it
                      calculateLoan();
                    }}
                  />
                </div>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
            ...
            <button className="w-full px-4 py-3 bg-green-600 text-white rounded-xl font-bold hover:bg-green-700 transition-all shadow-md hover:shadow-lg">
