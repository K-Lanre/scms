    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 bg-white rounded-xl shadow-sm border border-gray-100 p-8">
          {activeTab === "general" && (
            <form
              onSubmit={handleSubmit(onSaveSection("General"))}
            ...
            >
              ...
              <div>
                ...
                <input
                  type="text"
                  {...register("coopName", { required: "Name is required" })}
              ...
              <button
                type="submit"
                className="px-6 py-2 bg-blue-600 text-white rounded-lg font-bold hover:bg-blue-700 shadow-sm flex items-center"
              >
          ...
          {activeTab === "financial" && (
            <form
              onSubmit={handleSubmit(onSaveSection("Financial"))}
              className="space-y-6 animate-in fade-in duration-300"
            >
              <h2 className="text-lg font-bold text-gray-800 border-b pb-2">
              ...
              <div>
                ...
                <input
                  type="number"
                  step="0.1"
                  {...register("defaultInterest", { required: true })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                />
              </div>
              <div>
                ...
                <input
                  type="number"
                  {...register("maxLoan", { required: true })}
                  className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 outline-none"
                />
              </div>
              <div>
